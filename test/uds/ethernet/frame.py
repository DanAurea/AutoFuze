...
# Import PDU
from uds.pdu import *
from uds.transport.ethernet.payload import DiagnosticMessage, VehicleIdentificationVIN
...
for uds_message in uds_message_list:
    ethernet_diagnostic_message = DiagnosticMessage(source_address = 0x1020, target_address = 0xEE00) / uds_message
